...
ZABBIX_URL = "http://192.168.10.128/zabbix/api_jsonrpc.php"
ZABBIX_USER = "Admin"
ZABBIX_PASS = "zabbix"
...
TELEGRAM_BOT_TOKEN = (
    "7893592714:AAEvj3cQeAppPASEO716xTsUyJFYjssAbjY"
    if DEBUG
    else "7597484685:AAHg99TxBlwpjNhF4nUxQ-nZZZqth1dN0oM"
)
TELEGRAM_CHAT_ID = "-4664643005" if DEBUG else "-4670897200"
